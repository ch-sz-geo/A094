...
== Supportorganisation 
=== National
Der Bund unterstützt während der Einführung, Weiterentwicklung und des ÖREB-Katasters mit einer Supportorganisation die Koordination und den Informationsaustausch zwischen den Kantonen und dem Bund.
